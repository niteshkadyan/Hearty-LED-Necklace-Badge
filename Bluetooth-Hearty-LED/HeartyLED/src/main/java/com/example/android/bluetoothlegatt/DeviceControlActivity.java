...
public class DeviceControlActivity extends Activity implements View.OnClickListener{
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                tick.setImageResource(R.drawable.red_tick);
                invalidateOptionsMenu();
                clearUI();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(DeviceControlActivity.this);

        text   = (EditText)findViewById(R.id.send_value);

        image = (ImageView) findViewById(R.id.image);
        image.setImageResource(R.drawable.ic_twinheart);
    ...
    public void onClick(View v) {
        ...
        if(!data.equals("")) {
            ...
            Toast.makeText(this, "Provide an input first.",
